...
import { softPoolAddress, poolAbi } from "../../artifacts/StakePools";

import { SoftPoolIndicator } from "../SoftHardIndicators";
...
export default function SoftContent() {
  ...
  useContractRead({
    ...
    args: [userAddress as `0x${string}`, softPoolAddress],
    onSuccess(data) {
      setAllowance(data);
    },
    onError(err) {
  ...
  const { config: approveConfig } = usePrepareContractWrite({
    ...
    args: [softPoolAddress, 100_000_000n],
